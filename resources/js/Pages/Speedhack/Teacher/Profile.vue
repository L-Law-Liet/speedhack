<template>
	<teacher-layout>
		<section class="bg-account">
    		...
    		<section v-if="toggle_class == false">
...
<script>
	import ProfileData from '@/Speedhack/Components/Account/ProfileDataTeacher';
	import ProfileUpdate from '@/Speedhack/Components/Account/ProfileUpdateTeacher';
