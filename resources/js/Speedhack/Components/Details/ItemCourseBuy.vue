<template>
	<a href="/course" class="course-block">
        ...
        <div class="wrap">
        	...
        	<a href="" class="btn-main">Купить курс</a>
        </div>
    </a>
</template>
<script>
...
<style scoped>
	...
	.course-block .wrap .img{
		width: 155px;
		height: 155px;
	}

	.course-block .wrap .img img{
		width: 100%;
		height: 100%;
		object-fit: contain;
	}
	...
	.course-block:hover .price{
		color: #fff;
	}
	.course-block:hover .wrap .title{
		color: #fff;
	}
